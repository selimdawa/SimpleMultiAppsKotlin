<h1 align="center">Simple Multi Apps - Kotlin</h1>
...
*   **Multi-Application Platform**: Modular Android application bundling 12+ standalone utilities and tools.
*   **Rich Utility Ecosystem**: Blogger reader, Live TV, Video Player, PDF Reader, Stopwatch, Games, and more.
*   **Context-Aware Theming**: Adaptive UI support for dark and light modes.
*   **Resilient Offline Capabilities**: Local caching and preferences management.
...
*   **Networking:** [Retrofit](https://square.github.io/retrofit/), [Volley](https://github.com/google/volley)
*   **Media & PDF:** [Media3 ExoPlayer](https://developer.android.com/media/media3), Android PDF Viewer
...
```text
app/src/main/java/com/flatcode/simplemultiapps/
├── mainapp/            # Main Navigation & App Selection Dashboard
├── bloggerapp/         # Blogger Reader Module
├── candycrushgame/     # Candy Crush Game Module
├── jokeapp/            # Joke App Module
├── livetv/             # Live TV Player Module
├── multipledelete/     # Multi-Selection Delete Utility
├── newsapp/            # News Reader Module
├── pdfreader/          # PDF Reader Module
├── randomimagegenerating/ # Random Image Generator Module
├── stopwatch/          # Stopwatch Utility
├── videoplayer/        # Video Player Module
├── webapp/             # Web Application Wrapper
├── wordpress/          # WordPress Blog Reader Module
...
1.  Clone the repository:
    ```bash
    git clone https://github.com/selimdawa/SimpleMultiAppsKotlin.git
    ```
...
*   **Networking**: **Retrofit & Volley** (HTTP client and REST API integration).
*   **Media & Video**: **Media3 ExoPlayer** (High-performance audio/video playback).
...
## 🔗 Links & Resources
*   **Legacy Versions:**
    *   [Kotlin Old Code Version](https://github.com/selimdawa/SimpleMultiAppsKotlinOld/)
    *   [Java Old Code Version](https://github.com/selimdawa/SimpleMultiApps/)
